...
describe User do
  ...
  describe 'creating a user' do
    ...
    it 'should require a unique username' do
      ...
      user = User.create(email: 'test@test.com', password: 'password', membership: 'user', user_role_id: 1)
      expect( user ).not_to be_valid
    ...
    it 'should require a unique email' do
      user = User.create(username: 'Test2', email: 'test2@test.com', password: 'password', membership: 'user', user_role_id: 1)
      expect( user ).to be_valid
      expect( User.count ).to eq 1
      ...
      user = User.create(username: 'test2', password: 'password', membership: 'user', user_role_id: 1)
      expect( user ).not_to be_valid
  ...
  #
    it 'should require a password' do
      ...
      expect( User.count ).to eq 1
      user = User.create(username: 'Test', email: 'test@test.com', membership: 'user', user_role_id: 1)
      expect( user ).not_to be_valid
